...
export function IdleTimeoutGuard() {
  ...
  return (
    <div
      role="alert"
      className="fixed bottom-4 right-4 z-[9999] max-w-sm rounded-lg border border-yellow-300 bg-yellow-50 p-4 shadow-lg dark:border-yellow-700 dark:bg-yellow-900/90"
    >
