...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ref={ref}
    className={cn(
      "overflow-hidden p-2 text-foreground [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-muted-foreground/70",
      className
    )}
    {...props}
  />
...
const CommandShortcut = ({
  ...
  return (
    <span
      className={cn(
        "ms-auto text-xs tracking-widest text-muted-foreground/70",
        className
      )}
      {...props}
    />
