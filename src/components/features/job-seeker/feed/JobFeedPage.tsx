          ...
          {isSearchMode ? (
            <>
              ...
              {searchError && !searchLoading && (
                <div className="card-base rounded-lg sm:rounded-3xl py-6 sm:py-10 text-center">
                  <p className="text-sm text-muted-foreground">{t("errors.searchFailed")}</p>
                </div>
              )}

              {!searchLoading && !searchError && searchData?.jobs.length === 0 && (
                <div className="card-base rounded-lg sm:rounded-3xl py-8 sm:py-12 text-center">
            ...
            <>
              ...
              <div className="rounded-3xl border-border/60 bg-card px-4 py-4 shadow-[0_16px_40px_rgba(15,23,42,0.04)] max-sm:rounded-none max-sm:bg-transparent max-sm:px-0 max-sm:py-0 max-sm:shadow-none sm:border sm:px-5">
