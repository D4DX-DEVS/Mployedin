...
export function CandidateQuality({
  ...
  const qualityConfig = {
    strong: { label: "Strong", color: "text-emerald-600 dark:text-emerald-400", ring: "stroke-emerald-500", bg: "bg-emerald-50 dark:bg-emerald-950/20" },
    medium: { label: "Medium", color: "text-amber-600 dark:text-amber-400", ring: "stroke-amber-500", bg: "bg-amber-50 dark:bg-amber-950/20" },
    low: { label: "Low", color: "text-red-500", ring: "stroke-red-500", bg: "bg-red-50 dark:bg-red-950/20" },
  };
        ...
        <div className="relative shrink-0">
          <svg width="96" height="96" viewBox="0 0 96 96">
            ...
            <circle
              ...
              strokeWidth="6"
              strokeLinecap="round"
              className={cn("score-ring", config.ring)}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-[10px] text-muted-foreground">avg match</span>
          </div>
        </div>
