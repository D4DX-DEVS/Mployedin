      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="border-b border-border bg-muted/20">
          <div className="max-w-5xl mx-auto px-4 py-3 text-xs text-muted-foreground flex items-center gap-2">
            <Link href={`/${locale}/jobs`} className="hover:text-foreground transition-colors">{t("jobSearch")}</Link>
            <span>/</span>
              ...
              {job.requirements && (
                <div className="bg-card border border-border rounded-xl p-5 sm:p-6 space-y-4">
                  ...
                  {job.requirements.skills?.length > 0 && (
                    <div>
                      <p className="text-sm font-medium text-foreground mb-2">{t("skills")}</p>
                  ...
                  {job.requirements.education && (
                    <div>
                      <p className="text-sm font-medium text-foreground mb-1">{t("education")}</p>
                  ...
                  {job.requirements.languages?.length > 0 && (
                    <div>
                      <p className="text-sm font-medium text-foreground mb-2">{t("languages")}</p>
                      <div className="flex flex-wrap gap-2">
