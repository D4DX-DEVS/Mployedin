...
function OnboardingCard({ onboarding, onChanged }: { onboarding: Onboarding; onChanged: () => void }) {
  ...
  return (
    <div className="space-y-5 rounded-[28px] border border-border bg-card p-6">
      {/* Header */}
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div className="space-y-1">
          ...
          {onboarding.placement.jobTitle && (
            <p className="text-lg font-semibold text-foreground">{onboarding.placement.jobTitle}</p>
          )}
          {startDate && (
