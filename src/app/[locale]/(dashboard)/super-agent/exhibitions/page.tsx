...
import {
  ...
  MapPin, Building2, ThumbsUp, ThumbsDown,
} from "lucide-react";
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex-1 space-y-2">
                  ...
                  {item.participationDetails && (
                    <p className="text-sm text-muted-foreground">
                      <span className="font-medium">{t("participationDetails")}:</span> {item.participationDetails}
                    </p>
                  )}
                  ...
                  {item.reviewNote && (
                    <p className="text-sm mt-2 p-2 rounded bg-muted">
                      ...
                      {item.reviewedBy && (
                        <span className="text-xs ml-2">— {item.reviewedBy.name}</span>
                      )}
                    </p>
                  )}
                </div>
                ...
                {item.status === "pending" && (
                  <div className="flex gap-2 shrink-0">
                    <Button size="sm" variant="default" className="bg-emerald-600 hover:bg-emerald-700" onClick={() => openReview(item, "approved")}>
