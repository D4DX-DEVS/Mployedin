...
import { CheckCircle2, Clock, Circle, RefreshCw, Sparkles } from "lucide-react";
      ...
      <section className="workspace-hero-surface overflow-hidden rounded-[28px] p-6 sm:p-7">
        <div className="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-foreground sm:text-[2rem]">Task Board</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-muted-foreground">
              MPLOYEDIN development progress tracker.
            </p>
          </div>
          <Button variant="outline" size="sm" onClick={fetchTasks} className="gap-1.5 rounded-xl">
