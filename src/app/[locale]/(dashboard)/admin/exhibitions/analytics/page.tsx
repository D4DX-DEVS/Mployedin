  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <KPICard
          label="Avg Budget per Exhibition"
      ...
      <div className="rounded-xl border bg-card p-5">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          <StatusBar label="Pending" count={kpis.pending} total={kpis.totalRequests} color="bg-amber-500" />
            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-center">
                  <span className="flex items-center gap-1 justify-center"><Clock className="h-3.5 w-3.5" /> Pending</span>
                </TableHead>
                <TableHead className="text-center">
                  <span className="flex items-center gap-1 justify-center"><CheckCircle2 className="h-3.5 w-3.5" /> Approved</span>
                </TableHead>
                <TableHead className="text-center">
                  <span className="flex items-center gap-1 justify-center"><XCircle className="h-3.5 w-3.5" /> Rejected</span>
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
