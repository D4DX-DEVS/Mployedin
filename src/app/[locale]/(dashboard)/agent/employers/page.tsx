...
import { ArrowRight, BriefcaseBusiness, Building2, Check, Copy, Edit2, ExternalLink, Globe2, Link2, Loader2, MapPin, Power, PowerOff, Trash2, UserPlus, LogIn } from "lucide-react";
...
export default function AgentEmployersPage() {
  ...
  return (
    <div className="page-container">
      ...
      {/* Bare toolbar row, not a panel. The employer list below is a card grid,
          and the panel's label + heading + description restated the page title
          three times above a single search box. */}
      <TableToolbar
        search={search}
