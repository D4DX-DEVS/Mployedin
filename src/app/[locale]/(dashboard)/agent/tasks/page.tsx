      ...
      <section className="workspace-hero-surface overflow-hidden rounded-2xl p-4 sm:rounded-[28px] sm:p-6 md:p-7">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            <div key={m.key} className="workspace-glass-panel rounded-2xl p-3 sm:p-4">
        ...
        {loading ? (
          <div className="space-y-3">
            {Array.from({ length: 5 }).map((_, i) => (
              <div key={i} className="workspace-glass-panel rounded-2xl p-3 sm:p-4">
          ...
          <div className="space-y-3">
            {paginatedTasks.map((task) => (
              <div
                key={task._id}
                className={`workspace-glass-panel rounded-2xl p-3 sm:p-4 transition-all ${
