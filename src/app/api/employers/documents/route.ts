...
// Writes Employer.verificationDocs, so it declares the matching permission — which is
// also what makes withAuth apply its read-only sub-role check (withAuth.ts:270).
