    ...
    employer: [
      {
        items: [
          ...
          // group keeps only the less-frequent pipeline pages.
          {
            ...
            icon: "Briefcase",
            description: "Post, manage & promote job listings",
            descriptionAr: "نشر وإدارة وترويج الوظائف",
            children: [
              {
                title: "All Jobs",
                titleAr: "كل الوظائف",
                href: p("/employer/jobs"),
                icon: "Briefcase",
                description: "Active, draft & paused jobs",
          ...
          },
          {
            ...
            descriptionAr: "نقل المرشحين من التقديم إلى التوظيف",
            children: [
              {
                title: "Applied & Screening",
                titleAr: "التقديم والفرز",
                href: p("/employer/applications"),
                icon: "FileText",
                description: "Review and shortlist applicants",
                descriptionAr: "مراجعة المتقدمين وإضافتهم للقائمة المختصرة",
              },
              {
                title: "Interviews",
                titleAr: "المقابلات",
              ...
              },
              {
                ...
                icon: "UserCheck",
                description: "Confirmed hires & onboarding",
                descriptionAr: "التعيينات المؤكدة والإعداد",
              },
              {
                ...
                icon: "ShieldCheck",
                description: "Checks within the hiring workflow",
                descriptionAr: "التحقق ضمن مسار التوظيف",
              },
            ],
          },
          {
          ...
          },
          {
            ...
            icon: "MessageSquare",
            description: "Candidate conversations & scheduling",
            descriptionAr: "محادثات المرشحين والجدولة",
            children: [
              {
                title: "Messages",
                titleAr: "الرسائل",
              ...
              },
              {
                ...
                icon: "CalendarDays",
                description: "Interviews and team events",
                descriptionAr: "المقابلات وفعاليات الفريق",
              },
              {
              ...
              },
              {
                ...
                href: p("/notifications"),
                icon: "Bell",
                description: "Actionable updates and reminders",
                descriptionAr: "التحديثات والتذكيرات القابلة للتنفيذ",
              },
            ],
          },
          {
            ...
            icon: "BarChart2",
            description: "Analytics, activity & audit history",
            descriptionAr: "التحليلات والنشاط وسجل التدقيق",
            children: [
              {
                title: "Analytics",
                titleAr: "التحليلات",
          ...
          },
          {
            ...
            icon: "Settings",
            description: "Profile, hiring setup, team & billing",
            descriptionAr: "الملف وإعدادات التوظيف والفريق والفوترة",
            children: [
              {
              ...
              },
              {
                ...
                icon: "GitBranch",
                description: "Default pipeline for new jobs",
                descriptionAr: "المسار الافتراضي للوظائف الجديدة",
              },
              {
                ...
                icon: "SlidersHorizontal",
                description: "How AI weighs skills, experience & fit",
                descriptionAr: "كيف يوازن الذكاء الاصطناعي المهارات والخبرة",
              },
              {
                title: "Subscription",
                titleAr: "الاشتراك",
