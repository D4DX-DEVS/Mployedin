// Rewrite shared components + auth pages with useTranslations
// Run: node _rewrite_shared_auth_i18n.js
...
// ─── PublicHeader ───
writes["components/shared/PublicHeader.tsx"] = `"use client";
...
// ─── CookieConsent ───
writes["components/shared/CookieConsent.tsx"] = `"use client";
...
// ─── Login Page ───
writes["app/[locale]/(auth)/login/page.tsx"] = `"use client";
...
console.log("\nShared components & auth pages updated with useTranslations!");
